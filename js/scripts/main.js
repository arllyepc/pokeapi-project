...
const resultsSingle = document.getElementById("js-text-results-pokemons");
...
function openDetailsPokemon() {
  ...
  namePokemonModal.textContent = primeiraLetraMaiuscula(
...
function filterByTypes() {
  resultsSingle.textContent = "Pokémons";
  let idPokemon = this.getAttribute("code-type");

  const areaPokemons = document.getElementById("js-list-pokemons");
  const allTypes = document.querySelectorAll(".type-filter");
  const btnLoadMore = document.getElementById("js-btn-load-more");
  const countPokemonType = document.getElementById("js-count-pokemons");
        ...
        axios({
          ...
          if (infoCard.image) {
            ...
            createCardPokemon(
              ...
              infoCard.type,
              infoCard.nome,
              (infoCard.image = "img/no-image.png")
            );
          }
...
function searchPokemon() {
  ...
  axios({
    ...
    .then((response) => {
      ...
      resultsSingle.textContent = "Pokémon";
    ...
    .catch((error) => {
      ...
      areaPokemons.innerHTML = "";
      btnLoadMore.style.display = "none";
      countPokemons.textContent = "";
      resultsSingle.textContent = "Pokémon not found";
    });
}
